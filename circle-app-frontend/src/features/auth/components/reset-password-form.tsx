  ...
  return (
    <Box color={"white"} width={"brand.form"}>
      ...
      <FormControl display={"flex"} flexDirection={"column"} gap={"12px"}>
        <Input type="password" placeholder="New Password*" rounded={8} padding={5} fontSize={14} fontWeight={500} borderColor={"brand.borderAbu"} />
        <Input type="password" placeholder="Confirm New Password*" rounded={8} padding={5} fontSize={14} fontWeight={500} borderColor={"brand.borderAbu"} />
