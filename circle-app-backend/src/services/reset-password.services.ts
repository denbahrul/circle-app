      ...
      <html lang="en">
        <body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0">
          <div style="max-width: 600px; margin: 20px auto; background-color: #ffffff; padding: 20px; border-radius: 8px; text-align: center">
            ...
            <a href="${appUrl}/reset-password/${token}" style="color: #3498db; text-decoration: none; display: block; margin: 10px 0">${appUrl}/reset-password/</a>
            ...
            <a href="${appUrl}/reset-password/${token}" style="display: inline-block; margin-top: 20px; padding: 10px 20px; background-color: #04a51e; color: #ffffff; text-decoration: none; font-size: 16px; border-radius: 5px"
