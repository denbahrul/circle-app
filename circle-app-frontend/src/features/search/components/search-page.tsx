...
export default function SearchPage() {
  ...
  const otherSearch = others.filter((other) => other.fullname.toLocaleLowerCase().includes(keyword.toLocaleLowerCase()) || other.username?.toLocaleLowerCase().includes(keyword.toLocaleLowerCase()));
