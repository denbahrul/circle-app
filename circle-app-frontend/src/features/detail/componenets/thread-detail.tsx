...
export default function ThreadDetail({ profilePhoto, fullName, userName, postImage, postContent, like, reply, id, isLike, authorId, createdAt }: Thread & { isLike: boolean; authorId: number }) {
