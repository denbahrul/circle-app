  ...
  return (
    <Flex justifyContent={"space-between"} p={2}>
      <Box flex={"1"} position={"sticky"} top={0} px={2} height={"100vh"}>
        ...
        <Image src="https://images.pexels.com/photos/413885/pexels-photo-413885.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" height={"100%"} width={"100%"} rounded={4} objectFit="contain" />
      </Box>
      {isContentOpen && (
