...
export default function MediaList() {
  return (
    <Grid templateColumns={"repeat(3, 1fr)"} gap={1} padding={"8px 4px"}>
      ...
      <AspectRatio width={"100%"} ratio={1}>
        <Image src="https://images.pexels.com/photos/1036620/pexels-photo-1036620.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" rounded={4} objectFit="cover" />
      </AspectRatio>
      <AspectRatio width={"100%"} ratio={1}>
        <Image src="https://images.pexels.com/photos/413959/pexels-photo-413959.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" rounded={4} objectFit="cover" />
      </AspectRatio>
      <AspectRatio width={"100%"} ratio={1}>
